"""
Logging system setup for Sinus Extraction Image Segmentation.
...
def setup_logger(name: str = 'segmentation', level: int = logging.INFO) -> logging.Logger:
    """
    ...
    application. Ensures consistent formatting and prevents duplicate handlers
    when called multiple times. HTML color formatting improves readability
    ...
    Args:
        name: Logger name. Defaults to 'segmentation' for the main application
